...
function setSlider() {
    ...
    let cor1 = '#cd97ff'; // Verde
    let cor2 = '#2e0f2e'; // Dourado
    ...
    if (active === 0) {
        container.style.backgroundImage = 'radial-gradient(circle, #24003b, #090d1d)';
        ...
        container.style.backgroundImage = 'radial-gradient(circle, #fff, #bc39ce)';
        ...
        container.style.backgroundImage = 'radial-gradient(circle, #ffaf46, #bdfff1)';
